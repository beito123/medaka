...
var Assets = assets.NewFileSystem(map[string][]string{"/": []string{"static"}, "/static": []string{"medaka.yml"}, "/static/lang": []string{"eng.ini", "jpn.ini"}}, map[string]*assets.File{
	"/": &assets.File{
		Path:     "/",
		FileMode: 0x800001ff,
		Mtime:    time.Unix(1533455582, 1533455582020781700),
		Data:     nil,
	}, "/static": &assets.File{
		Path:     "/static",
		FileMode: 0x800001ff,
		Mtime:    time.Unix(1533455582, 1533455582023791700),
		Data:     nil,
	}, "/static/lang": &assets.File{
		Path:     "/static/lang",
		FileMode: 0x800001ff,
		Mtime:    time.Unix(1533455582, 1533455582022779600),
		Data:     nil,
	}, "/static/lang/eng.ini": &assets.File{
		Path:     "/static/lang/eng.ini",
		FileMode: 0x1b6,
		Mtime:    time.Unix(1533455582, 1533455582021780600),
